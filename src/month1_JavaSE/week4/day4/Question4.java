    ...
    public static void main(String[] args) {
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                ...
                try {
                    out = new BufferedWriter(new FileWriter("src/month1_JavaSE.week4/day4/IOtest/time.txt", true));
                    out.write(time + "\r\n");
                    out.flush();
                    out.close();
                } catch (IOException e) {
        ...
        // void schedule(TimerTask month1_JavaSE.task, long delay, long period)

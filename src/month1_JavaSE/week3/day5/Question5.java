...
public class Question5 {
    public static void main(String[] args) throws IOException {
        ...
        //动词文件夹
        FileOutputStream outVerb = new FileOutputStream("src\\month1_JavaSE.week3\\day5\\test\\verb.txt",true);
        //名词文件夹
        FileOutputStream outNoun = new FileOutputStream("src\\month1_JavaSE.week3\\day5\\test\\noun.txt",true);

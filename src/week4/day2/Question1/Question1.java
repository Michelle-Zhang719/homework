...
public class Question1 {
    public static void main(String[] args) {
        ...
        CopyFile copyFile = new CopyFile("src/week4/day2/Question1/test.txt", "src/week4/day2/Question1/IOtest/a.txt");
        copyFile.start();

        CopyFile copyFile2 = new CopyFile("src/week4/day2/Question1/test2.txt", "src/week4/day2/Question1/IOtest/b.txt");
        copyFile2.start();

        CopyFile copyFile3 = new CopyFile("src/week4/day2/Question1/test3.txt", "src/week4/day2/Question1/IOtest/c.txt");
        copyFile3.start();
    }
}

...
public class Question3 {
    public static void main(String[] args) {
        ...
        NewCopyFile copyFile = new NewCopyFile("src/week4/day2/Question3/test.txt", "src/week4/day2/Question3/IOtest/a.txt");
        Thread t1 = new Thread(copyFile);

        NewCopyFile copyFile2 = new NewCopyFile("src/week4/day2/Question3/test2.txt", "src/week4/day2/Question3/IOtest/b.txt");
        Thread t2 = new Thread(copyFile2);

        NewCopyFile copyFile3 = new NewCopyFile("src/week4/day2/Question3/test3.txt", "src/week4/day2/Question3/IOtest/c.txt");

...
public class Question3 {
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        FileOutputStream out = new FileOutputStream("src/week4/day4/path.txt");
...
class CopyFile implements Callable<String> {
    File sourceFile = new File("src/week4/day4/第1题结果.png");
    File targetFile = new File("src/week4/第1题结果.png");

...
public class Question2 {
    public static void main(String[] args) throws IOException {
        BufferedReader in = new BufferedReader(new FileReader("src/week4/day1/Question2/a.txt"));
...
//        }
        //已经分好组了
        BufferedWriter out = new BufferedWriter(new FileWriter("src/week4/day1/Question2/b.txt", true));
        //写两行
